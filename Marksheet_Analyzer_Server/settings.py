"""
Django settings for Marksheet_Analyzer_Server project.
...
SECRET_KEY = 'akjhza8wk#%mmpcl*dd3n-ovm!ntc*83+pnzhrb-)1!zw!#h$#'
...
WSGI_APPLICATION = 'Marksheet_Analyzer_Server.wsgi.application'
